...
const hero = `<section class="canon-hero" data-canon-hero>
  ...
  <div class="canon-hero-inner">
    ...
    <div class="canon-slider" data-hero-slider data-active="1" tabindex="0" aria-label="Featured House categories">
      <div class="canon-slide-track">
        <article class="canon-slide canon-slide-operator" data-slide="0">
          <img src="https://images.unsplash.com/photo-1719228159232-48608b807a58?auto=format&fit=crop&w=900&q=84" alt="Casino chips on a gaming table" width="760" height="980" fetchpriority="high">
        ...
        <article class="canon-slide canon-slide-tip" data-slide="1">
          <img src="https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=900&q=84" alt="Football player celebrating in a stadium" width="760" height="980" fetchpriority="high">
...
html = html.replace('</head>', '<link rel="stylesheet" href="/src/styles/canonical-hero.css?v=090"></head>');
